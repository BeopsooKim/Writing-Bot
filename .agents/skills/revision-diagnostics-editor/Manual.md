# Revision Diagnostics Editor Manual
...
Diagnoses a provided draft at the level of claim, evidence, analysis, logic, clarity, tone, and structure.

## When to use

- When the user already has text.
- For paragraph-level or section-level critique.
- When the goal is diagnosis rather than full drafting.
...
```text
$revision-diagnostics-editor
Text: [paste draft]
Document type: [paper / email / SOP / report]
Audience: [reader]
Please diagnose claim-evidence-analysis, logic gaps, and revision priorities.
```
...
# Revision Diagnostics Editor 사용 설명서
...
사용자가 제공한 초안을 주장, 근거, 분석, 논리, 명확성, 어조, 구조 관점에서 진단합니다.

## 사용해야 하는 경우

- 이미 작성된 텍스트가 있을 때.
- 문단 또는 섹션 단위 비평이 필요할 때.
- 전체 작성보다 진단이 목표일 때.
